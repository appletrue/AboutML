...
考虑如果有三种可能，即伯努利抛硬币试验中，硬币比较厚，有可能立起来，即可能是正面，反面，立起来，其概率分别是p1,p2,p3，那么进行n次试验以后，正面出现x1次，反面x2次，立起来x3次的（保证x1+x2+x3=n)概率是多少？

猜想式子如:$\frac{n!}{x_1!x_2!x_3!} p_1^{x_1}p_2^{x_2}p_3^{x_3}$,即多项式的分布的表达式.
...
$= C^{x1}_np^{x1}_1C^{x2}_{n−x1}p^{x2}_2...C^{x_m}_{n−x_1−x_2−..x_m−1}p_m^{x_m}$
